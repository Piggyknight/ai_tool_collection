...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'no-redmine-sync',
        description: '跳过 Redmine 状态和归档说明同步',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'no-redmine-sync',
        description: '当 artifact 为 apply 时跳过 Redmine 状态同步',
      },
    ],
  },
  {
        ...
        flags: [
          {
            name: 'due-date',
            short: 'd',
            description: 'Sprint due date (YYYY-MM-DD)',
            takesValue: true,
          },
          {
            name: 'description',
        ...
        flags: [
          {
            name: 'auto',
            short: 'a',
            description: 'Auto-select all proposals',
          },
        ],
      },
      {
    ...
    subcommands: [
      {
        ...
        acceptsPositional: true,
        positionals: [{ name: 'sprint-name' }, { name: 'change-name' }],
        flags: [
          {
            name: 'interactive',
            short: 'i',
      ...
      },
      {
        ...
        acceptsPositional: true,
        positionals: [{ name: 'change-name', optional: true }],
        flags: [],
      },
    ],
  },
  {
    ...
    subcommands: [
        ...
        flags: [
          {
            name: 'severity',
            short: 's',
            description: 'Bug severity (critical|major|minor|trivial)',
            takesValue: true,
          },
          {
            name: 'related-story',
            description: 'Related story name',
            takesValue: true,
          },
          {
            name: 'related-task',
            description: 'Related task name',
            takesValue: true,
          },
          {
            name: 'description',
      ...
      },
      {
        ...
        acceptsPositional: true,
        positionals: [{ name: 'bug-id' }],
        flags: [
          {
            name: 'status',
            description: 'New status (new|in-progress|fixed|verified)',
            takesValue: true,
          },
          {
            name: 'severity',
            description: 'New severity (critical|major|minor|trivial)',
            takesValue: true,
          },
          {
            name: 'note',
  ...
  },
  {
    ...
    subcommands: [
        ...
        flags: [
          {
            name: 'parent',
            short: 'p',
            description: 'Parent Redmine issue ID',
            takesValue: true,
          },
          {
            name: 'interactive',
      ...
      },
      {
        ...
        acceptsPositional: true,
        positionals: [{ name: 'change-name' }],
        flags: [
          {
            name: 'dry-run',
            description: 'Preview without syncing',
          },
          {
            name: 'verbose',
            short: 'v',
    ...
    subcommands: [
      {
        ...
        flags: [
          ...
          {
            name: 'sync',
            description: 'Sync review result to Redmine',
          },
        ],
      },
      {
        ...
        acceptsPositional: true,
        positionals: [{ name: 'sprint-name' }],
        flags: [
          {
            name: 'fail-on-issues',
            short: 'f',
            description: 'Fail on any issues',
          },
          {
            name: 'verbose',
            short: 'v',
    ...
    subcommands: [
      {
        ...
        flags: [
          {
            name: 'code-stats',
            description: 'Include code statistics',
          },
          {
            name: 'time-stats',
            description: 'Include time statistics',
          },
          {
            name: 'output',
            short: 'o',
        ...
        flags: [
          {
            name: 'format',
            short: 'f',
            description: 'Document format (markdown)',
            takesValue: true,
          },
          {
            name: 'page',
