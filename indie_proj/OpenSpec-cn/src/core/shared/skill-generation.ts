...
import {
  ...
  getUpdateToolsSkillTemplate,
  getOpsxUpdateToolsCommandTemplate,
  type SkillTemplate,
...
export function getSkillTemplates(workflowFilter?: readonly string[]): SkillTemplateEntry[] {
  const all: SkillTemplateEntry[] = [
    ...
    { template: getUpdateToolsSkillTemplate(), dirName: 'openspec-update-tools', workflowId: 'update-tools' },
  ];
...
export function getCommandTemplates(workflowFilter?: readonly string[]): CommandTemplateEntry[] {
  const all: CommandTemplateEntry[] = [
    ...
    { template: getOpsxUpdateToolsCommandTemplate(), id: 'update-tools' },
  ];
